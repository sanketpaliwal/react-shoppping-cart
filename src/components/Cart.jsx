    ...
    showModal && (
      <div className="flex-col flex items-center fixed inset-0 left-1/4 bg-white dark:bg-black gap-8  p-10  text-black dark:text-white font-normal uppercase text-sm">
        ...
        </div>
        {
          ...
          <button style={{backgroundColor:"gray", height:"40px",width:"150px",borderRadius:"10px",margin:"20px",fontWeight:"bold",padding:"5 px",border:"2px solid white",color:"black"}}>Proceed To Payment</button>
        </div>
          ) : (
